                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">Имейл</label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Повтори
                                    паролата</label>
...
{{--                                Желая да получавам материали и известия по пощата.--}}
{{--                            </div>--}}
