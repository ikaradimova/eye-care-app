...
@section("content")
    <section>
        ...
        <div class="close-eye-quiz-container">
            ...
            <i class="fas fa-info-circle info" data-toggle="modal" data-target="#central-vision-instructions-modal"></i>
        </div>

        <!-- Modal -->
        <div class="modal fade" id="central-vision-instructions-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="fa-ul">
                            ...
                            <li><i class="far fa-eye"></i>Преценете дали виждате всички линии прави или наблюдавате различни деформации. Изберете правилния отговор.</li>
                        </ul>
