    ...
    <section>
        ...
        <div class="close-eye-quiz-container">
            <div class="close-eye-quiz">
                ...
                <span id="contrast-eye-c"><span id="letter-c">C</span></span>
            </div>
            <i class="fas fa-info-circle info" data-toggle="modal" data-target="#contrast-eye-instructions-modal"></i>
        </div>

        <!-- Modal -->
        <div class="modal fade" id="contrast-eye-instructions-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="fa-ul">
                            ...
                            <li><i class="far fa-eye"></i>Изберете посоката на отворената част на <strong class="letter-in-text">С</strong> чрез натискане на бутон от клавиатурата или на мишката.</li>
                        </ul>
